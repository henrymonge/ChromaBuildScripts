...
export LIBDEVICE="-libdevice-path /opt/rocm-5.3.0/llvm/lib -libdevice-name libomptarget-new-amdgpu-gfx90a.bc"
...
MPI_CFLAGS="${CRAY_XPMEM_INCLUDE_OPTS} -I${MPICH_DIR}/include -I${ROCM_PATH}/include/hipblas -I/opt/rocm-6.3.0/include/hipfft"
