...
module load amd/6.2.0
module load rocmcc/6.0.2-magic
...
export ROCM_PATH=/usr/tce/packages/rocmcc/rocmcc-6.0.2-magic
...
export LIBDEVICE="-libdevice-path /opt/rocm-6.2.0/llvm/lib -libdevice-name libomptarget-new-amdgpu-gfx90a.bc"
...
MPI_CFLAGS="${CRAY_XPMEM_INCLUDE_OPTS} -I${MPICH_DIR}/include -I${ROCM_PATH}/include/hipblas -I/opt/rocm-6.2.0/include/hipfft"
